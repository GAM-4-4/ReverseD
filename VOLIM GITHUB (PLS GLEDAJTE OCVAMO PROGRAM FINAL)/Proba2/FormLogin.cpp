        ...
        wxSYSTEM_MENU | wxMINIMIZE_BOX | wxCLOSE_BOX | wxCAPTION | wxCLIP_CHILDREN)
{
    ...
    m_profesor = new wxButton(panel, 10010, wxT("Profesor sam"));
    hbox3->Add(m_profesor);
...
void FormLogin::ProfesorSam(wxCommandEvent& event) {
    m_frame3 = new cDnevnik();
    m_frame3->Show();
    nijeProf = false;
    Close();
...
EVT_BUTTON(10010, FormLogin::ProfesorSam)
END_EVENT_TABLE()