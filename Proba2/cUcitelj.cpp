...
cUcitelj::cUcitelj(wxMDIParentFrame* parent, wxString sName) : wxMDIChildFrame(parent, wxID_ANY, sName) {
	...
	m_ocjena = new wxTextCtrl(this, wxID_ANY, "Unesi ocjenu od 1 do 5 u formatu ocjena,brojKriterija \n (npr. 5,3 za davanje petice iz Težine ispita u odnosu na predavano", wxPoint(50, 630), wxSize(375, 50));
